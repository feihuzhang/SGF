...
command=sprintf('./SGF %s %s %s %d %.2f %.2f %d',guidfile, targetfile,outfile, 32,0.04,0.4,1);
%%%%%%for linux
...
%%%%%%if you use windows please use the following command.
command=sprintf('./SGF %s %s %s %d %.2f %.2f %d',guidfile, targetfile,outfile, 32,0.025,0.25,1);
%%%%%%for linux
%command=sprintf('./SGF %s %s %s %d %.2f %.2f %d',guidfile, targetfile,outfile, 32,0.05,0.05,1);
dos(command);
img=imread(outfile);
