...
#pragma omp parallel for
	...
	//	end=clock();
	//	printf("test1 Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
		//-----------------------------------------------------------------
...
//	end=clock();
//	printf("test2 Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
	...
	const string&				path) 
{
        ...
        int sz = width*height;
	ofstream outfile;
	outfile.open("labels.txt",ios::out);
...
//	printf("Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
	...
	///////////////////////////
//	end=clock();
//	printf("DetectLabEdges Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
	/////////////////////////////////////
	//int start=clock();
	...
	///////////////////////////
//	int	end=clock();
//	printf("PerformSuperpixelSLIC Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
	/////////////////////////////////////
	int* nlabels = new int[sz];
	EnforceLabelConnectivity(klabels, m_width, m_height, nlabels, numlabels, double(sz)/double(STEP*STEP));
///////////////////////////
//	end=clock();
//	printf("EnforceLabelConnectivity Elapsed time: %lf secs...\n",(double)(end-start)/CLOCKS_PER_SEC);
/////////////////////////////////////
