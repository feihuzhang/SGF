...
%%%%%%for linux
%command=sprintf('./SGF %s %s %s %d %.2f %.2f %d',imgname, imgname,outfile, radius,eps,thresh,iter);
dos('./SGF smooth/1.png smooth/1.png smooth/1_smooth.png 12 0.1 0.2 3');
dos('./SGF smooth/2.png smooth/2.png smooth/2_smooth.png 16 0.05 0.1 3');
dos('./SGF smooth/3.png smooth/3.png smooth/3_smooth.png 8 0.05 0.2 3');
%}
